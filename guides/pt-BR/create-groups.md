...
3. Se o iOS pedir permissão de Screen Time, permita. O App Lock usa isso apenas para bloquear o que você escolher.
...
1. Use categorias para bloquear um tipo inteiro de app de uma vez.
2. Use a busca quando a lista for longa.
3. Você pode editar os apps selecionados depois nos detalhes do grupo.
