...
2. Toque em **MANAGE**.
3. Toque em **Set Schedule**.
4. Ative **Use Schedule**.
5. Escolha o horário de bloqueio e desbloqueio.
...
Se precisar de regras diferentes para dias diferentes, crie um grupo separado para cada rotina.
