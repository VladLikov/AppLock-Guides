...
3. Si iOS demande l’autorisation Screen Time, acceptez. App Lock l’utilise seulement pour bloquer ce que vous choisissez.
...
1. Utilisez les catégories pour bloquer tout un type d’apps à la fois.
2. Utilisez la recherche si la liste est longue.
3. Vous pouvez modifier la sélection plus tard depuis les détails du groupe.
