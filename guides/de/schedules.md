...
2. Tippe auf **MANAGE**.
3. Tippe auf **Set Schedule**.
4. Aktiviere **Use Schedule**.
5. Wähle Sperr- und Entsperrzeit.
...
Wenn du für verschiedene Tage unterschiedliche Regeln brauchst, erstelle für jede Routine eine eigene Gruppe.
